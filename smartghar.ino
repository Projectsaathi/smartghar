...
//-----------------------------------------------------------------------//    
  ...
  else if(voice == "*everything off" || voice == "*everything of"){alloff();} //Turn On  All Pins (Call Function)
  
  //----------Turn On One-By-One----------// 
  else if(voice == "*first light on") {digitalWrite(led1, HIGH);} 
  else if(voice == "*light on") { digitalWrite(led2, HIGH);}
  else if(voice == "*all on") {digitalWrite(led1, HIGH); digitalWrite(led2, HIGH);}
 
  //----------Turn Off One-By-One----------// 
  else if(voice == "*first light off") {digitalWrite(led1, LOW);} 
  else if(voice == "*light off" || voice == "*light of") {digitalWrite(led2, LOW);}
  else if(voice == "*all off" || voice == "*all of") {digitalWrite(led1, LOW); digitalWrite(led2, LOW);}
